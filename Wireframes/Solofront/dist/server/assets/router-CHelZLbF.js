...
const roomArImg = "/assets/room-ar-BWziTLDO.jpg";
const roomComputersImg = "/assets/room-computers-D2Vv4Zo_.jpg";
const roomMachinesImg = "/assets/room-machines-CFb0MuwG.jpg";
const roomChemistryImg = "/assets/room-chemistry-BBsBNDX7.jpg";
const roomPhysicsImg = "/assets/room-physics-Q4lCDgC3.jpg";
const MOCK_USERS = [
  { id: "u1", name: "Carlos Pérez", email: "carlos@uts.edu.co", role: "docente", teacherId: "DOC-2024-001" },
  { id: "u2", name: "María García", email: "maria@uts.edu.co", role: "coordinador" },
  { id: "u3", name: "Admin UTS", email: "admin@uts.edu.co", role: "administrador" },
  { id: "u4", name: "Juan Rodríguez", email: "juan@uts.edu.co", role: "docente", teacherId: "DOC-2024-002" },
  { id: "u5", name: "Ana López", email: "ana@uts.edu.co", role: "docente", teacherId: "DOC-2024-003" }
];
const MOCK_ROOMS = [
  {
    id: "r1",
    ...
    capacity: 30,
    equipment: ["Gafas VR (15 unidades)", "PC Gaming (15)", "Proyector 4K", "Sistema de tracking"],
    description: "Laboratorio equipado con tecnología de última generación para experiencias inmersivas de realidad virtual y aumentada.",
    images: [roomArImg],
    status: "habilitada"
  },
  {
    ...
    capacity: 25,
    equipment: ["Kits de ensamblaje (25)", "Osciloscopios (10)", "Multímetros (25)", "Componentes de hardware"],
    description: "Espacio dedicado al estudio y ensamblaje de componentes de hardware, arquitectura de computadores y sistemas digitales.",
    images: [roomComputersImg],
    status: "habilitada"
  },
  {
    id: "r3",
    name: "Laboratorio de Máquinas",
    capacity: 20,
    equipment: ["Torno CNC", "Fresadora", "Taladro de banco", "Soldadura MIG/TIG", "Equipos de seguridad"],
    description: "Taller industrial con maquinaria para procesos de manufactura, mecanizado y fabricación de piezas.",
    images: [roomMachinesImg],
  ...
  },
  {
    ...
    capacity: 28,
    equipment: ["Campanas extractoras (4)", "Balanzas analíticas (10)", "pH-metros (10)", "Cristalería completa"],
    description: "Laboratorio certificado para prácticas de química general, orgánica e inorgánica con equipamiento profesional.",
    images: [roomChemistryImg],
    status: "habilitada"
  },
  {
    id: "r5",
    name: "Lab. Física y Electromecánica",
    capacity: 24,
    equipment: ["Osciloscopios digitales (12)", "Generadores de señales (12)", "Motores eléctricos", "Bancos de pruebas"],
    description: "Laboratorio para experimentos de física, electrónica y electromecánica con instrumentación de medición avanzada.",
    images: [roomPhysicsImg],
    status: "habilitada"
  }
];
const MOCK_RESERVATIONS = [
  {
    id: "res1",
    roomId: "r1",
    roomName: "Realidad Aumentada",
    userId: "u1",
    userName: "Carlos Pérez",
    date: "2026-04-15",
    startTime: "08:00",
    endTime: "10:00",
    reason: "Práctica de modelado 3D",
    subject: "Realidad Virtual",
    studentCount: 25,
    observations: "Requiere software Unity instalado",
    status: "aprobada",
  ...
  },
  {
    id: "res3",
    roomId: "r3",
    roomName: "Laboratorio de Máquinas",
    userId: "u4",
    userName: "Juan Rodríguez",
    date: "2026-04-17",
    startTime: "10:00",
    endTime: "12:00",
    reason: "Práctica de torneado CNC",
    subject: "Procesos de Manufactura",
    studentCount: 15,
    observations: "Materiales ya solicitados",
    status: "en_revision",
  ...
  },
  {
    id: "res4",
    roomId: "r5",
    roomName: "Lab. Física y Electromecánica",
    userId: "u5",
    userName: "Ana López",
    date: "2026-04-18",
    startTime: "08:00",
    endTime: "10:00",
    reason: "Mediciones con osciloscopio",
  ...
  },
  {
    id: "res5",
    roomId: "r2",
    roomName: "Estructura de Computadores",
    userId: "u4",
    userName: "Juan Rodríguez",
    date: "2026-04-20",
    startTime: "14:00",
    endTime: "16:00",
    reason: "Ensamblaje de PC",
...
const MOCK_NOTIFICATIONS = [
  { id: "n1", userId: "u1", message: "Tu solicitud para Realidad Aumentada ha sido aprobada", type: "success", read: false, createdAt: "2026-04-11T15:00:00" },
  { id: "n2", userId: "u1", message: "Tu solicitud para Lab. Química está en revisión", type: "info", read: true, createdAt: "2026-04-11T10:30:00" },
  { id: "n3", userId: "u2", message: "Nueva solicitud pendiente de Carlos Pérez", type: "info", read: false, createdAt: "2026-04-11T10:30:00" },
  { id: "n4", userId: "u2", message: "Nueva solicitud pendiente de Juan Rodríguez", type: "info", read: false, createdAt: "2026-04-11T14:00:00" },
  { id: "n5", userId: "u5", message: "Tu solicitud para Lab. Física fue rechazada", type: "error", read: false, createdAt: "2026-04-10T09:00:00" }
];
const VALID_TEACHER_IDS = ["DOC-2024-001", "DOC-2024-002", "DOC-2024-003", "DOC-2024-004", "DOC-2024-005"];
const AuthContext = reactExports.createContext(null);
function AuthProvider({ children }) {
  const [user, setUser] = reactExports.useState(null);
  const [reservations, setReservations] = reactExports.useState(MOCK_RESERVATIONS);
  ...
  const login = reactExports.useCallback(async (email, _password) => {
  ...
  const register = reactExports.useCallback(async (_data) => {
  }, []);
  const addReservation = reactExports.useCallback((r) => {
    const newRes = {
      ...r,
      id: `res${Date.now()}`,
      status: "en_revision",
    ...
    setNotifications((prev) => [
      {
        id: `n${Date.now()}`,
        userId: "u2",
        message: `Nueva solicitud pendiente de ${r.userName}`,
        type: "info",
        read: false,
        createdAt: (/* @__PURE__ */ new Date()).toISOString()
      },
  ...
  const updateReservationStatus = reactExports.useCallback((id, status) => {
    setReservations(
      ...
      setNotifications((prev) => [
        {
          id: `n${Date.now()}`,
          userId: res.userId,
          message: status === "aprobada" ? `Tu solicitud para ${res.roomName} ha sido aprobada` : `Tu solicitud para ${res.roomName} ha sido rechazada`,
  ...
  const markNotificationRead = reactExports.useCallback((id) => {
    setNotifications(
      (prev) => prev.map((n) => n.id === id ? { ...n, read: true } : n)
    );
  }, []);
  const addUser = reactExports.useCallback((u) => {
    setUsers((prev) => [...prev, { ...u, id: `u${Date.now()}` }]);
  }, []);
  const deleteUser = reactExports.useCallback((id) => {
    setUsers((prev) => prev.filter((u) => u.id !== id));
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    AuthContext.Provider,
    {
      value: { user, login, logout, register, reservations, addReservation, updateReservationStatus, notifications, markNotificationRead, users, addUser, deleteUser },
      children
    }
  );
}
...
const appCss = "/assets/styles-BrfCuiy6.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-7xl font-bold text-foreground font-heading", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 text-xl font-semibold text-foreground", children: "Página no encontrada" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "La página que buscas no existe." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90", children: "Ir al inicio" }) })
  ] }) });
}
const Route$e = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "GESTIUTS - Sistema de Reservas" },
      { name: "description", content: "Sistema de reservas de aulas especiales de las Unidades Tecnológicas de Santander" }
    ],
    links: [
...
const $$splitComponentImporter$d = () => import("./request-history-BRZy01yD.js");
const Route$d = createFileRoute("/request-history")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./register-BSIg5Pdi.js");
const Route$c = createFileRoute("/register")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./profile-a9AfRNWp.js");
const Route$b = createFileRoute("/profile")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./notifications-BxtVVUID.js");
const Route$a = createFileRoute("/notifications")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./my-requests-a1VipyE_.js");
const Route$9 = createFileRoute("/my-requests")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./my-history-AFdzh6c2.js");
const Route$8 = createFileRoute("/my-history")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./manage-users-NAe7Fb2Z.js");
const Route$7 = createFileRoute("/manage-users")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./manage-rooms-DamQOuHI.js");
const Route$6 = createFileRoute("/manage-rooms")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./manage-requests-BANA3ANo.js");
const Route$5 = createFileRoute("/manage-requests")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./forgot-password-eeVrgByq.js");
const Route$4 = createFileRoute("/forgot-password")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./dashboard-DCT8xqiY.js");
const Route$3 = createFileRoute("/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./all-requests-u-xilvA9.js");
const Route$2 = createFileRoute("/all-requests")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./index-B8d2SZEA.js");
const Route$1 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./room._roomId-Bx61ffis.js");
const Route2 = createFileRoute("/room/$roomId")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const RequestHistoryRoute = Route$d.update({
  id: "/request-history",
...
const NotificationsRoute = Route$a.update({
  id: "/notifications",
  path: "/notifications",
  getParentRoute: () => Route$e
});
const MyRequestsRoute = Route$9.update({
  id: "/my-requests",
  path: "/my-requests",
  getParentRoute: () => Route$e
});
const MyHistoryRoute = Route$8.update({
  id: "/my-history",
  path: "/my-history",
  getParentRoute: () => Route$e
});
const ManageUsersRoute = Route$7.update({
  id: "/manage-users",
  path: "/manage-users",
  getParentRoute: () => Route$e
});
const ManageRoomsRoute = Route$6.update({
  id: "/manage-rooms",
  path: "/manage-rooms",
  getParentRoute: () => Route$e
});
const ManageRequestsRoute = Route$5.update({
  id: "/manage-requests",
...
const AllRequestsRoute = Route$2.update({
  id: "/all-requests",
  path: "/all-requests",
  getParentRoute: () => Route$e
});
...
const RoomRoomIdRoute = Route2.update({
  id: "/room/$roomId",
  path: "/room/$roomId",
  getParentRoute: () => Route$e
});
