import { $ as requireReact, M as useRouter, r as reactExports, U as jsxRuntimeExports, a0 as React } from "./worker-entry-DXb4SRss.js";
import { r as reactDomExports, c as ReactDOM, u as useAuth, L as Link, a as useNavigate } from "./router-CHelZLbF.js";
import { c as createLucideIcon, e as createSlot$3, b as cn, a as composeRefs, u as useComposedRefs, d as cva, B as Button, S as Slot$2, I as Input, L as Label } from "./label-CSFn5qIn.js";
...
const docenteItems = [
  ...
  { title: "Mi Historial", url: "/my-history", icon: History },
  { title: "Notificaciones", url: "/notifications", icon: Bell }
];
const coordinadorItems = [
  { title: "Dashboard", url: "/dashboard", icon: LayoutDashboard },
  { title: "Gestionar Solicitudes", url: "/manage-requests", icon: ClipboardList },
  { title: "Gestionar Aulas", url: "/manage-rooms", icon: Building2 },
  { title: "Historial", url: "/request-history", icon: FileText },
  { title: "Notificaciones", url: "/notifications", icon: Bell }
];
const adminItems = [
  { title: "Dashboard", url: "/dashboard", icon: LayoutDashboard },
  { title: "Gestionar Usuarios", url: "/manage-users", icon: Users },
  { title: "Gestionar Aulas", url: "/manage-rooms", icon: Building2 },
  { title: "Todas las Solicitudes", url: "/all-requests", icon: ClipboardList }
];
function AppSidebar() {
  ...
  if (!user) return null;
  const items = user.role === "docente" ? docenteItems : user.role === "coordinador" ? coordinadorItems : adminItems;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { collapsible: "icon", className: "border-r-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarContent, { className: "bg-sidebar", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-3 py-4 mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: gestiutsLogo, alt: "GESTIUTS", width: 32, height: 32, className: "shrink-0" }),
        !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading font-bold text-sidebar-foreground text-lg", children: "GESTIUTS" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupLabel, { className: "text-sidebar-foreground/50 text-xs uppercase tracking-wider", children: !collapsed && (user.role === "docente" ? "Docente" : user.role === "coordinador" ? "Coordinador" : "Administrador") }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarFooter, { className: "bg-sidebar border-t border-sidebar-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarMenu, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuButton, { asChild: true, className: "text-sidebar-foreground/80 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/profile", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "h-4 w-4" }),
        !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Perfil" })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarMenuButton, { onClick: logout, className: "text-sidebar-foreground/80 hover:bg-destructive/20 hover:text-destructive", children: [
...
function NotificationBell() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { open, onOpenChange: setOpen, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "icon", className: "relative", children: [
      ...
      unreadCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1 -right-1 h-5 w-5 rounded-full bg-destructive text-destructive-foreground text-xs flex items-center justify-center animate-scale-in", children: unreadCount })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PopoverContent, { align: "end", className: "w-80 p-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3 border-b border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-sm", children: "Notificaciones" }),
        unreadCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "sm", className: "text-xs h-7", onClick: () => userNotifs.forEach((n) => markNotificationRead(n.id)), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCheck, { className: "h-3 w-3 mr-1" }),
          "Marcar todas"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "max-h-64", children: userNotifs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "p-4 text-sm text-muted-foreground text-center", children: "Sin notificaciones" }) : userNotifs.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          onClick: () => markNotificationRead(n.id),
          className: `p-3 border-b border-border last:border-0 cursor-pointer hover:bg-muted/50 transition-colors ${!n.read ? "bg-primary/5" : ""}`,
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `mt-1 h-2 w-2 rounded-full shrink-0 ${n.type === "success" ? "bg-success" : n.type === "error" ? "bg-destructive" : "bg-info"}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-sm ${!n.read ? "font-medium" : "text-muted-foreground"}`, children: n.message }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: new Date(n.createdAt).toLocaleDateString("es-CO") })
            ] })
          ] })
        },
        n.id
...
function ProfileMenu() {
  const { user, logout } = useAuth();
  const [open, setOpen] = reactExports.useState(false);
  const [pwDialog, setPwDialog] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { open, onOpenChange: setOpen, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", className: "flex items-center gap-2 h-auto py-1.5 px-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "h-8 w-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-primary text-primary-foreground text-xs font-semibold", children: initials }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium hidden sm:inline", children: user.name })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(PopoverContent, { align: "end", className: "w-56 p-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-2 py-1.5 mb-1 border-b border-border", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-primary capitalize mt-0.5", children: user.role })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/profile", onClick: () => setOpen(false), className: "flex items-center gap-2 px-2 py-1.5 text-sm rounded-md hover:bg-muted transition-colors cursor-pointer", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "h-4 w-4" }),
          "Perfil"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => {
          setPwDialog(true);
          setOpen(false);
        }, className: "flex items-center gap-2 px-2 py-1.5 text-sm rounded-md hover:bg-muted transition-colors w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "h-4 w-4" }),
          "Cambiar contraseña"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border mt-1 pt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: logout, className: "flex items-center gap-2 px-2 py-1.5 text-sm rounded-md hover:bg-destructive/10 text-destructive transition-colors w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LogOut, { className: "h-4 w-4" }),
          "Cerrar sesión"
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: pwDialog, onOpenChange: setPwDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      ...
      pwSuccess ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-4 animate-scale-in", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "h-12 w-12 text-success mx-auto mb-3" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: "Contraseña actualizada" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Contraseña actual" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "password", required: true })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Nueva contraseña" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "password", required: true })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Confirmar nueva contraseña" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "password", required: true })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", className: "w-full", children: "Actualizar contraseña" })
      ] })
    ] }) })
  ] });
}
function DashboardLayout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex w-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "h-14 flex items-center justify-between border-b border-border bg-card px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarTrigger, { className: "shrink-0" }),
